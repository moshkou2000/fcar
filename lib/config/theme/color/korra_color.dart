...
abstract final class ThemeColor {
  static const primary = Color(0xff004881);
  static const onPrimary = Color(0xFFFFFFFF);
  static const primaryContainer = Color(0xffd0e4ff);
  ...
  static const onSecondaryContainer = Color(0xFFCFC202);
  static const tertiary = Color(0xff006875);
  static const onTertiary = Color(0xFFFFFFFF);
  static const tertiaryContainer = Color(0xff95f0ff);
  static const onTertiaryContainer = Color(0xFFFFEE00);
  static const error = Color(0xffb00020);
  static const onError = Color(0xFFFFFFFF);
  static const errorContainer = Color(0xFFB0001D);
